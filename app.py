...
def home():
    recipes = [
        ...
        {'id': 2, 'title': 'Chicken Curry', 'description': 'A spicy and flavorful dish duh.'},
        {'id': 3, 'title': 'Chocolate Cake', 'description': 'Brother under what rock have you been sleeping for the last few millenia?'}
    ]
